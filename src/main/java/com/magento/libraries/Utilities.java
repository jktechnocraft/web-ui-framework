...
public class Utilities {
	...
	public void syncElement(WebDriver driver, WebElement element, String conditionForWait) {
		try {
			...
			default:
				throw new MagentoException("Invalid Condition " + conditionForWait);
			}
		} catch (Exception e) {
			throw new MagentoException("Could Not Sync WebElement " + e.getMessage());
		}
	}
	...
	public void clickElement(WebDriver driver, WebElement element) {
		...
		try {
			...
			throw new MagentoException("Could Not Click WebElement " + e.getMessage());
		}
	}
	...
	public void scrollToWebElement(WebDriver driver, WebElement element) {
		try {
			...
			throw new MagentoException("Could Not Scroll WebElement " + e.getMessage());
		}
	}
	...
	public void clickElementByJSE(WebDriver driver, WebElement element) {
		...
		try {
			...
			throw new MagentoException("Clicking WebElement By JavaScriptExecutor Failed " + e.getMessage());
		}
	}
	...
	public void moveToElement(WebDriver driver, WebElement element) {
		try {
			...
			throw new MagentoException("Move MouseOver Action WebElement Failed " + e.getMessage());
		}
	}
	...
	public void sendKeysThruAction(WebDriver driver, WebElement element, String stringToInput) {
		try {
			...
			throw new MagentoException("SendKeys Thru Action Failed " + e.getMessage());
		}
	}
	...
	public void selectOptionFromList(WebDriver driver, List<WebElement> webElementList, String optionValue,
		...
		try {
			...
			throw new MagentoException("Clicking WebElement From List Failed " + e.getMessage());
		}
	}
	...
	public void sleepInMilliSeconds(int milliSeconds) {
		try {
			...
			throw new MagentoException("Explicit Sleep Failed " + e.getMessage());
		}
	}
	...
	public String getRandomString(int stringLength, String dataType) {
		...
		default:
			throw new MagentoException("Invalid Datatype For Random String ");
		}
		try {
			...
			throw new MagentoException("Random String Generation Failed " + e.getMessage());
		}
